...
document.getElementById("fname").innerHTML="first name is :"+fname+"<br>";
document.getElementById("lname").innerHTML="last name is :"+lname+"<br>";
document.getElementById("email").innerHTML="email name is :"+email+"<br>";
document.getElementById("pass").innerHTML="password name is :"+password+"<br>";
